...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  created: function created() {
    ...
    axios.get('http://127.0.0.1:8000/api/bikes').then(function (response) {
      // handle success
      console.log(response.data); // Popolo l'array inizializzato nei data con i data dell'API
...
__webpack_require__(/*! /Applications/MAMP/htdocs/laravel-model-migration/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/laravel-model-migration/resources/sass/app.scss */"./resources/sass/app.scss");
